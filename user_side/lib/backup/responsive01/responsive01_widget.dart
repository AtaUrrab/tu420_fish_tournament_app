...
import 'responsive01_model.dart';
export 'responsive01_model.dart';

class Responsive01Widget extends StatefulWidget {
  const Responsive01Widget({super.key});

  @override
  State<Responsive01Widget> createState() => _Responsive01WidgetState();
}

class _Responsive01WidgetState extends State<Responsive01Widget> {
  late Responsive01Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Responsive01Model());
