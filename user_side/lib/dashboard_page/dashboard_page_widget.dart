                          ...
                          child: StreamBuilder<List<TournamentsRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<TournamentsRecord>
                                  wrapTournamentsRecordList = snapshot.data!;
                              return Wrap(
                                spacing: 0.0,
                                runSpacing: 0.0,
                                ...
                                children: List.generate(
                                    wrapTournamentsRecordList.length,
                                    (wrapIndex) {
                                  final wrapTournamentsRecord =
                                      wrapTournamentsRecordList[wrapIndex];
                                  return Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        16.0, 16.0, 16.0, 0.0),
                                    child: Container(
                                                      ...
                                                      child: StreamBuilder<
                                                          ...
                                                          queryBuilder:
                                                              (anglersPaymentColRecord) =>
                                                                  anglersPaymentColRecord
                                                                      ...
                                                                      .where(
                                                                        'tournamentID',
                                                                        isEqualTo: wrapTournamentsRecord
                                                                            .reference
                                                                            .id,
                                                                      ),
                                                          singleRecord: true,
                                                        ...
                                                        builder: (context,
                                                          ...
                                                          List<AnglersPaymentColRecord>
                                                              buttonAnglersPaymentColRecordList =
                                                              snapshot.data!;
                                                          ...
                                                          final buttonAnglersPaymentColRecord =
                                                              buttonAnglersPaymentColRecordList
                                                                      .isNotEmpty
                                                                  ? buttonAnglersPaymentColRecordList
                                                                      .first
